import svgPaths from "./svg-3kv6fxusyg";
...
function Frame2() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full">
      <p className="flex-[1_0_0] font-['Montserrat:Bold',sans-serif] font-bold leading-[normal] min-h-px min-w-px relative text-[#4d4085] text-[27px] whitespace-pre-wrap">Configure User Access</p>
    </div>
  );
}
...
function Frame3() {
  return (
    <div className="content-stretch flex flex-col items-start py-[5px] relative shrink-0 w-full">
      <Frame2 />
    </div>
  );
}
...
function Frame1() {
  return (
    <div className="content-stretch flex items-center relative shrink-0">
      <p className="font-['Montserrat:Bold',sans-serif] font-bold leading-[normal] relative shrink-0 text-[#5ea7a3] text-[21px]">Add User Access Module</p>
    </div>
  );
}
...
function Frame7() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-[500px]">
      <p className="font-['Poppins:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#5b5b5b] text-[14px]">Offering Groups</p>
      <div className="bg-white content-stretch flex h-[32px] items-center justify-between px-[15px] relative rounded-[30px] shrink-0 w-[250px]" data-name="Dropdown Small">
        <div aria-hidden="true" className="absolute border border-[#3a3a3a] border-solid inset-0 pointer-events-none rounded-[30px]" />
        <p className="font-['Poppins:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#3a3a3a] text-[14px] tracking-[-0.14px]">Manage</p>
        <div className="h-[18px] relative shrink-0 w-[24px]">
          <div className="flex flex-col items-center justify-center size-full">
              ...
              <div className="h-[5px] relative shrink-0 w-[10px]">
                <div className="absolute inset-[-20%_-10%_-28.28%_-10%]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 7.41422">
                    <path d="M1 1L5.96894 6L11 1" id="Vector 1" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeWidth="2" />
                  </svg>
                </div>
              </div>
            </div>
      ...
      <div className="h-0 relative shrink-0 w-full">
        <div className="absolute inset-[-1px_0_0_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1220 1">
            <line id="Line 222" stroke="var(--stroke-0, #ACACAC)" x2="1220" y1="0.5" y2="0.5" />
          </svg>
        </div>
      </div>
    </div>
...
function Frame8() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-[500px]">
      <p className="font-['Poppins:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#5b5b5b] text-[14px]">Offering</p>
      <div className="bg-white content-stretch flex h-[32px] items-center justify-between px-[15px] relative rounded-[30px] shrink-0 w-[250px]" data-name="Dropdown Small">
        <div aria-hidden="true" className="absolute border border-[#3a3a3a] border-solid inset-0 pointer-events-none rounded-[30px]" />
        <p className="font-['Poppins:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#3a3a3a] text-[14px] tracking-[-0.14px]">Manage</p>
        <div className="h-[18px] relative shrink-0 w-[24px]">
...
function Frame11() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] h-[42px] items-start relative shrink-0 w-full">
      <Frame8 />
      <div className="h-0 relative shrink-0 w-full">
        <div className="absolute inset-[-1px_0_0_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1220 1">
...
function Frame9() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-[500px]">
      <p className="font-['Poppins:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#5b5b5b] text-[14px]">My Deals</p>
      <div className="bg-white content-stretch flex h-[32px] items-center justify-between px-[15px] relative rounded-[30px] shrink-0 w-[250px]" data-name="Dropdown Small">
        <div aria-hidden="true" className="absolute border border-[#3a3a3a] border-solid inset-0 pointer-events-none rounded-[30px]" />
        <p className="font-['Poppins:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#3a3a3a] text-[14px] tracking-[-0.14px]">Manage</p>
        <div className="h-[18px] relative shrink-0 w-[24px]">
...
function Frame14() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-[500px]">
      <p className="font-['Poppins:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#5b5b5b] text-[14px]">Post Sale Portal</p>
      <div className="bg-white content-stretch flex h-[32px] items-center justify-between px-[15px] relative rounded-[30px] shrink-0 w-[250px]" data-name="Dropdown Small">
        <div aria-hidden="true" className="absolute border border-[#3a3a3a] border-solid inset-0 pointer-events-none rounded-[30px]" />
        <p className="font-['Poppins:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#3a3a3a] text-[14px] tracking-[-0.14px]">Manage</p>
        <div className="h-[18px] relative shrink-0 w-[24px]">
...
function Frame16() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-[500px]">
      <p className="font-['Poppins:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#5b5b5b] text-[14px]">SAM Documents</p>
      <div className="bg-white content-stretch flex h-[32px] items-center justify-between px-[15px] relative rounded-[30px] shrink-0 w-[250px]" data-name="Dropdown Small">
        <div aria-hidden="true" className="absolute border border-[#3a3a3a] border-solid inset-0 pointer-events-none rounded-[30px]" />
        <p className="font-['Poppins:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#3a3a3a] text-[14px] tracking-[-0.14px]">Manage</p>
        <div className="h-[18px] relative shrink-0 w-[24px]">
...
function Frame18() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-[500px]">
      <p className="font-['Poppins:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#5b5b5b] text-[14px]">Messages</p>
      <div className="bg-white content-stretch flex h-[32px] items-center justify-between px-[15px] relative rounded-[30px] shrink-0 w-[250px]" data-name="Dropdown Small">
        <div aria-hidden="true" className="absolute border border-[#3a3a3a] border-solid inset-0 pointer-events-none rounded-[30px]" />
        <p className="font-['Poppins:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#3a3a3a] text-[14px] tracking-[-0.14px]">Manage</p>
        <div className="h-[18px] relative shrink-0 w-[24px]">
...
function Frame20() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-[500px]">
      <p className="font-['Poppins:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#5b5b5b] text-[14px]">Members</p>
      <div className="bg-white content-stretch flex h-[32px] items-center justify-between px-[15px] relative rounded-[30px] shrink-0 w-[250px]" data-name="Dropdown Small">
        <div aria-hidden="true" className="absolute border border-[#3a3a3a] border-solid inset-0 pointer-events-none rounded-[30px]" />
        <p className="font-['Poppins:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#3a3a3a] text-[14px] tracking-[-0.14px]">Manage</p>
        <div className="h-[18px] relative shrink-0 w-[24px]">
...
function Frame4() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-full">
      ...
      <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-full" data-name="Configure User Access">
        <Frame10 />
        <Frame11 />
        <Frame12 />
        <Frame13 />
...
function Frame6() {
  return (
    <div className="content-stretch flex flex-col gap-[32px] h-[728px] items-start overflow-clip relative shrink-0 w-full">
      <Frame3 />
      <Frame4 />
    </div>
  );
...
function Buttons() {
  return (
    <div className="content-stretch flex gap-[20px] items-center justify-end relative shrink-0 w-full" data-name="Buttons">
      <div className="bg-white content-stretch flex h-[49px] items-center justify-center px-[80px] py-[12px] relative rounded-[100px] shrink-0 w-[177px]">
        <div aria-hidden="true" className="absolute border border-[#46367f] border-solid inset-0 pointer-events-none rounded-[100px]" />
        <p className="font-['Poppins:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#5ea7a3] text-[14px]">Cancel</p>
      </div>
      <div className="bg-[#46367f] content-stretch flex h-[49px] items-center justify-center px-[80px] py-[12px] relative rounded-[100px] shrink-0 w-[201px]">
        <div aria-hidden="true" className="absolute border border-[#46367f] border-solid inset-0 pointer-events-none rounded-[100px]" />
...
function InnerFrame() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-end justify-between min-h-px min-w-px relative w-full" data-name="Inner Frame">
      <Frame6 />
      <Buttons />
    </div>
  );
...
export default function EditUserAccess() {
  return (
    <div className="bg-white content-stretch flex items-center relative size-full" data-name="Edit User Access">
