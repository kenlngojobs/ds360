import svgPaths from "./svg-naqj43v33b";
...
function Frame1() {
  return (
    <div className="content-stretch flex items-center relative shrink-0">
      <p className="font-['Montserrat:Bold',sans-serif] font-bold leading-[normal] relative shrink-0 text-[#352b5d] text-[27px]">Users</p>
    </div>
  );
}
...
function Frame2() {
  return (
    <div className="content-stretch flex flex-col items-start px-[10px] py-[5px] relative shrink-0">
      <Frame1 />
    </div>
  );
}
...
function Frame3() {
  return (
    <div className="content-stretch flex items-center relative shrink-0">
      <p className="font-['Poppins:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#46367f] text-[14px]">Refresh</p>
    </div>
  );
}
...
function Frame5() {
  return (
    <div className="content-stretch flex gap-[15px] items-start relative shrink-0">
      <div className="bg-[#4d4085] content-stretch flex h-[49px] items-center justify-center px-[30px] py-[12px] relative rounded-[50px] shrink-0" data-name="Component 17">
        <p className="font-['Poppins:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[16px] text-white">Add New User</p>
      </div>
      <div className="bg-white content-stretch flex gap-[10px] h-[49px] items-center justify-center px-[60px] py-[12px] relative rounded-[100px] shrink-0 w-[200px]" data-name="Refresh">
        <div aria-hidden="true" className="absolute border border-[#46367f] border-solid inset-0 pointer-events-none rounded-[100px]" />
        <div className="h-[20px] relative shrink-0 w-[20.01px]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20.01 20">
            <path d={svgPaths.p11dc9340} fill="var(--fill-0, #46367F)" id="Vector" />
          </svg>
        </div>
        <Frame3 />
      </div>
...
function Frame6() {
  return (
    <div className="h-[25px] relative shrink-0 w-[5px]">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5 25">
        <g id="Frame 427320327">
          <circle cx="2.5" cy="2.5" fill="var(--fill-0, black)" id="Ellipse 6" r="2.5" />
          <circle cx="2.5" cy="12.5" fill="var(--fill-0, black)" id="Ellipse 7" r="2.5" />
          <circle cx="2.5" cy="22.5" fill="var(--fill-0, black)" id="Ellipse 8" r="2.5" />
        </g>
      </svg>
    </div>
  );
...
function Frame7() {
  return (
    <div className="content-stretch flex gap-[5px] items-center justify-end relative shrink-0">
      <Frame5 />
      <div className="content-stretch flex items-center justify-center p-[10px] relative shrink-0 size-[44px]" data-name="Option Menu">
        <Frame6 />
      </div>
    </div>
  );
...
function UserName() {
  return (
    <div className="content-stretch flex gap-[10px] items-center px-[10px] relative shrink-0 w-[350px]" data-name="User Name">
      <div className="flex flex-[1_0_0] flex-col font-['Poppins:Medium',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic relative text-[12px] text-white tracking-[-0.12px]" style={{ fontFeatureSettings: "\'ss01\', \'cv01\', \'cv11\'" }}>
        <p className="leading-[14px] whitespace-pre-wrap">User Name</p>
      </div>
  ...
  return (
    <div className="content-stretch flex gap-[10px] items-center px-[10px] relative shrink-0 w-[200px]" data-name="First Name">
      <div className="flex flex-[1_0_0] flex-col font-['Poppins:Medium',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic relative text-[12px] text-center text-white tracking-[-0.12px]" style={{ fontFeatureSettings: "\'ss01\', \'cv01\', \'cv11\'" }}>
        <p className="leading-[14px] whitespace-pre-wrap">First Name</p>
      </div>
      <div className="content-stretch flex flex-col h-[20px] items-center justify-center pl-[10px] pr-[15px] py-[10px] relative shrink-0" data-name="Column Filter">
        <div aria-hidden="true" className="absolute border-r border-solid border-white inset-0 pointer-events-none" />
        <div className="h-[5px] relative shrink-0 w-[10px]">
...
function LastName() {
  return (
    <div className="content-stretch flex gap-[10px] items-center px-[10px] relative shrink-0 w-[200px]" data-name="Last Name">
      <div className="flex flex-[1_0_0] flex-col font-['Poppins:Medium',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic relative text-[12px] text-center text-white tracking-[-0.12px]" style={{ fontFeatureSettings: "\'ss01\', \'cv01\', \'cv11\'" }}>
        <p className="leading-[14px] whitespace-pre-wrap">Last Name</p>
      </div>
      <div className="content-stretch flex flex-col h-[20px] items-center justify-center pl-[10px] pr-[15px] py-[10px] relative shrink-0" data-name="Column Filter">
        <div aria-hidden="true" className="absolute border-r border-solid border-white inset-0 pointer-events-none" />
        <div className="h-[5px] relative shrink-0 w-[10px]">
...
function Partner() {
  return (
    <div className="content-stretch flex gap-[10px] items-center px-[10px] relative shrink-0 w-[350px]" data-name="Partner">
      <div className="flex flex-[1_0_0] flex-col font-['Poppins:Medium',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic relative text-[12px] text-center text-white tracking-[-0.12px]" style={{ fontFeatureSettings: "\'ss01\', \'cv01\', \'cv11\'" }}>
        <p className="leading-[14px] whitespace-pre-wrap">Partner</p>
      </div>
      <div className="content-stretch flex flex-col h-[20px] items-center justify-center pl-[10px] pr-[15px] py-[10px] relative shrink-0" data-name="Column Filter">
        <div aria-hidden="true" className="absolute border-r border-solid border-white inset-0 pointer-events-none" />
        <div className="h-[5px] relative shrink-0 w-[10px]">
...
function PartnerType() {
  return (
    <div className="content-stretch flex gap-[10px] items-center px-[10px] relative shrink-0 w-[200px]" data-name="Partner Type">
      <div className="flex flex-[1_0_0] flex-col font-['Poppins:Medium',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic relative text-[12px] text-center text-white tracking-[-0.12px]" style={{ fontFeatureSettings: "\'ss01\', \'cv01\', \'cv11\'" }}>
        <p className="leading-[14px] whitespace-pre-wrap">Partner Type</p>
      </div>
      <div className="content-stretch flex flex-col h-[20px] items-center justify-center pl-[10px] pr-[15px] py-[10px] relative shrink-0" data-name="Column Filter">
        <div aria-hidden="true" className="absolute border-r border-solid border-white inset-0 pointer-events-none" />
        <div className="h-[5px] relative shrink-0 w-[10px]">
...
function UserName1() {
  return (
    <div className="content-stretch flex h-[38px] items-center justify-between p-[10px] relative shrink-0 w-[350px]" data-name="User Name">
      <div aria-hidden="true" className="absolute border-r border-solid border-white inset-0 pointer-events-none" />
      <div className="flex flex-[1_0_0] flex-col font-['Poppins:Regular',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#3a3a3a] text-[12px]">
        <p className="leading-[normal] whitespace-pre-wrap">adam@recoverymanagementsolutionllc.com</p>
      </div>
    </div>
  );
}
...
function FirstName1() {
  return (
    <div className="content-stretch flex items-center justify-between p-[10px] relative shrink-0 w-[200px]" data-name="First Name">
      <div className="flex flex-[1_0_0] flex-col font-['Poppins:Regular',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#3a3a3a] text-[12px] text-center">
        <p className="leading-[normal] whitespace-pre-wrap">Adam</p>
      </div>
    </div>
  );
}
...
function LastName1() {
  return (
    <div className="content-stretch flex items-center justify-between p-[10px] relative shrink-0 w-[200px]" data-name="Last Name">
      <div className="flex flex-[1_0_0] flex-col font-['Poppins:Regular',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#3a3a3a] text-[12px] text-center">
        <p className="leading-[normal] whitespace-pre-wrap">Kazmark</p>
      </div>
    </div>
  );
}
...
function Partner1() {
  return (
    <div className="content-stretch flex items-center justify-between p-[10px] relative shrink-0 w-[350px]" data-name="Partner">
      <div className="flex flex-[1_0_0] flex-col font-['Poppins:Regular',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#3a3a3a] text-[12px] text-center">
        <p className="leading-[normal] whitespace-pre-wrap">Recovery Management Solutions, LLC (RMS)</p>
      </div>
    </div>
  );
}
...
function PartnerType1() {
  return (
    <div className="content-stretch flex items-center justify-between p-[10px] relative shrink-0 w-[200px]" data-name="Partner Type">
      <div className="flex flex-[1_0_0] flex-col font-['Poppins:Regular',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#3a3a3a] text-[12px] text-center">
        <p className="leading-[normal] whitespace-pre-wrap">Buyer</p>
      </div>
    </div>
  );
}
...
function Status1() {
  return (
    <div className="content-stretch flex items-center justify-between p-[10px] relative shrink-0 w-[200px]" data-name="Status">
      <div className="flex flex-[1_0_0] flex-col font-['Poppins:Regular',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#3a3a3a] text-[12px] text-center">
        <p className="leading-[normal] whitespace-pre-wrap">Suspended</p>
      </div>
    </div>
  );
}
...
function UserName2() {
  return (
    <div className="content-stretch flex h-[38px] items-center justify-between p-[10px] relative shrink-0 w-[350px]" data-name="User Name">
      <div aria-hidden="true" className="absolute border-r border-solid border-white inset-0 pointer-events-none" />
      <div className="flex flex-[1_0_0] flex-col font-['Poppins:Regular',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#3a3a3a] text-[12px]">
        <p className="leading-[normal] whitespace-pre-wrap">adowdey@denali-capital.com</p>
      </div>
    </div>
  );
}
...
function FirstName2() {
  return (
    <div className="content-stretch flex items-center justify-between p-[10px] relative shrink-0 w-[200px]" data-name="First Name">
      <div className="flex flex-[1_0_0] flex-col font-['Poppins:Regular',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#3a3a3a] text-[12px] text-center">
        <p className="leading-[normal] whitespace-pre-wrap">Amy</p>
      </div>
    </div>
  );
}
...
function LastName2() {
  return (
    <div className="content-stretch flex items-center justify-between p-[10px] relative shrink-0 w-[200px]" data-name="Last Name">
      <div className="flex flex-[1_0_0] flex-col font-['Poppins:Regular',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#3a3a3a] text-[12px] text-center">
        <p className="leading-[normal] whitespace-pre-wrap">Dowdey</p>
      </div>
    </div>
  );
}
...
function Partner2() {
  return (
    <div className="content-stretch flex items-center justify-between p-[10px] relative shrink-0 w-[350px]" data-name="Partner">
      <div className="flex flex-[1_0_0] flex-col font-['Poppins:Regular',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#3a3a3a] text-[12px] text-center">
        <p className="leading-[normal] whitespace-pre-wrap">Denali Capital</p>
      </div>
    </div>
  );
}
...
function PartnerType2() {
  return (
    <div className="content-stretch flex items-center justify-between p-[10px] relative shrink-0 w-[200px]" data-name="Partner Type">
      <div className="flex flex-[1_0_0] flex-col font-['Poppins:Regular',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#3a3a3a] text-[12px] text-center">
        <p className="leading-[normal] whitespace-pre-wrap">Seller</p>
      </div>
    </div>
  );
}
...
function Status2() {
  return (
    <div className="content-stretch flex items-center justify-between p-[10px] relative shrink-0 w-[200px]" data-name="Status">
      <div className="flex flex-[1_0_0] flex-col font-['Poppins:Regular',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#3a3a3a] text-[12px] text-center">
        <p className="leading-[normal] whitespace-pre-wrap">Inactive</p>
      </div>
    </div>
  );
}
...
function Row1() {
  return (
    <div className="content-stretch flex gap-[10px] items-start relative shrink-0 w-full" data-name="Row 2">
      <div aria-hidden="true" className="absolute border-[#e0dfdf] border-b border-solid inset-0 pointer-events-none" />
      <UserName2 />
      <FirstName2 />
      <LastName2 />
...
function UserName3() {
  return (
    <div className="content-stretch flex h-[38px] items-center justify-between p-[10px] relative shrink-0 w-[350px]" data-name="User Name">
      <div aria-hidden="true" className="absolute border-r border-solid border-white inset-0 pointer-events-none" />
      <div className="flex flex-[1_0_0] flex-col font-['Poppins:Regular',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#3a3a3a] text-[12px]">
        <p className="leading-[normal] whitespace-pre-wrap">anees.ahmad@gmail.com</p>
      </div>
    </div>
  );
}
...
function FirstName3() {
  return (
    <div className="content-stretch flex items-center justify-between p-[10px] relative shrink-0 w-[200px]" data-name="First Name">
      <div className="flex flex-[1_0_0] flex-col font-['Poppins:Regular',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#3a3a3a] text-[12px] text-center">
        <p className="leading-[normal] whitespace-pre-wrap">Anees</p>
      </div>
    </div>
  );
}
...
function LastName3() {
  return (
    <div className="content-stretch flex items-center justify-between p-[10px] relative shrink-0 w-[200px]" data-name="Last Name">
      <div className="flex flex-[1_0_0] flex-col font-['Poppins:Regular',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#3a3a3a] text-[12px] text-center">
        <p className="leading-[normal] whitespace-pre-wrap">Ahmad</p>
      </div>
    </div>
  );
}
...
function Partner3() {
  return (
    <div className="content-stretch flex items-center justify-between p-[10px] relative shrink-0 w-[350px]" data-name="Partner">
      <div className="flex flex-[1_0_0] flex-col font-['Poppins:Regular',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#3a3a3a] text-[12px] text-center">
        <p className="leading-[normal] whitespace-pre-wrap">Takkar</p>
      </div>
    </div>
  );
}
...
function Row2() {
  return (
    <div className="content-stretch flex gap-[10px] items-start relative shrink-0 w-full" data-name="Row 3">
      <div aria-hidden="true" className="absolute border-[#e0dfdf] border-b border-solid inset-0 pointer-events-none" />
      <UserName3 />
      <FirstName3 />
      <LastName3 />
...
function Row3() {
  return (
    <div className="content-stretch flex gap-[10px] items-start relative shrink-0 w-full" data-name="Row 4">
      <div aria-hidden="true" className="absolute border-[#e0dfdf] border-b border-solid inset-0 pointer-events-none" />
      <UserName4 />
      <FirstName4 />
      <LastName4 />
...
function Row4() {
  return (
    <div className="content-stretch flex gap-[10px] items-start relative shrink-0 w-full" data-name="Row 5">
      <div aria-hidden="true" className="absolute border-[#e0dfdf] border-b border-solid inset-0 pointer-events-none" />
      <UserName5 />
      <FirstName5 />
      <LastName5 />
...
function Row5() {
  return (
    <div className="content-stretch flex gap-[10px] items-start relative shrink-0 w-full" data-name="Row 6">
      <div aria-hidden="true" className="absolute border-[#e0dfdf] border-b border-solid inset-0 pointer-events-none" />
      <UserName6 />
      <FirstName6 />
      <LastName6 />
...
function Row6() {
  return (
    <div className="content-stretch flex gap-[10px] items-start relative shrink-0 w-full" data-name="Row 7">
      <div aria-hidden="true" className="absolute border-[#e0dfdf] border-b border-solid inset-0 pointer-events-none" />
      <UserName7 />
      <FirstName7 />
      <LastName7 />
...
function Row7() {
  return (
    <div className="content-stretch flex gap-[10px] items-start relative shrink-0 w-full" data-name="Row 8">
      <div aria-hidden="true" className="absolute border-[#e0dfdf] border-b border-solid inset-0 pointer-events-none" />
      <UserName8 />
      <FirstName8 />
      <LastName8 />
...
function Row8() {
  return (
    <div className="content-stretch flex gap-[10px] items-start relative shrink-0 w-full" data-name="Row 9">
      <div aria-hidden="true" className="absolute border-[#e0dfdf] border-b border-solid inset-0 pointer-events-none" />
      <UserName9 />
      <FirstName9 />
      <LastName9 />
...
function Row9() {
  return (
    <div className="content-stretch flex gap-[10px] items-start relative shrink-0 w-full" data-name="Row 10">
      <div aria-hidden="true" className="absolute border-[#e0dfdf] border-b border-solid inset-0 pointer-events-none" />
      <UserName10 />
      <FirstName10 />
      <LastName10 />
...
function Row10() {
  return (
    <div className="content-stretch flex gap-[10px] items-start relative shrink-0 w-full" data-name="Row 11">
      <div aria-hidden="true" className="absolute border-[#e0dfdf] border-b border-solid inset-0 pointer-events-none" />
      <UserName11 />
      <FirstName11 />
      <LastName11 />
...
function Row11() {
  return (
    <div className="content-stretch flex gap-[10px] items-start relative shrink-0 w-full" data-name="Row 12">
      <div aria-hidden="true" className="absolute border-[#e0dfdf] border-b border-solid inset-0 pointer-events-none" />
      <UserName12 />
      <FirstName12 />
      <LastName12 />
...
function Row12() {
  return (
    <div className="content-stretch flex gap-[10px] items-start relative shrink-0 w-full" data-name="Row 13">
      <div aria-hidden="true" className="absolute border-[#e0dfdf] border-b border-solid inset-0 pointer-events-none" />
      <UserName13 />
      <FirstName13 />
      <LastName13 />
...
function Row13() {
  return (
    <div className="content-stretch flex gap-[10px] items-start relative shrink-0 w-full" data-name="Row 14">
      <div aria-hidden="true" className="absolute border-[#e0dfdf] border-b border-solid inset-0 pointer-events-none" />
      <UserName14 />
      <FirstName14 />
      <LastName14 />
...
function Data() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-full" data-name="Data">
      <Row />
      <Row1 />
      <Row2 />
      <Row3 />
...
function InnerFrame() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[27px] items-start min-h-px min-w-px overflow-clip relative w-full" data-name="Inner Frame">
      <Frame8 />
      <div className="bg-white content-stretch flex flex-col gap-[10px] h-[634px] items-start overflow-x-clip overflow-y-auto relative shrink-0 w-full" data-name="Table - Users">
        <Header />
        <Data />
      </div>
    </div>
  ...
  return (
    <div className="bg-[#acacac] h-[10px] relative rounded-[5px] shrink-0 w-full" data-name="Horizontal Scrollbar">
      <div className="content-stretch flex flex-col items-start p-px relative size-full">
        <div className="flex h-[8px] items-center justify-center relative shrink-0 w-[400px]" style={{ "--transform-inner-width": "1186.171875", "--transform-inner-height": "0" } as React.CSSProperties}>
          <div className="-rotate-90 flex-none">
            <div className="bg-[#5b5b5b] h-[400px] rounded-[20px] w-[8px]" />
          </div>
        </div>
      </div>
    </div>
...
export default function User() {
  return (
    <div className="bg-white content-stretch flex items-start relative size-full" data-name="User">
