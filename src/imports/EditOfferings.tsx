import svgPaths from "./svg-u9dw6236ms";
...
function Frame2() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full">
      <p className="flex-[1_0_0] font-['Montserrat:Bold',sans-serif] font-bold leading-[normal] min-h-px min-w-px relative text-[#4d4085] text-[27px] whitespace-pre-wrap">Configure Offering Access</p>
    </div>
  );
}
...
function Frame1() {
  return (
    <div className="content-stretch flex items-center relative shrink-0">
      <p className="font-['Montserrat:Bold',sans-serif] font-bold leading-[normal] relative shrink-0 text-[#5ea7a3] text-[21px]">Add Offerings</p>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[31px]">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 31 31">
        <g id="Frame 427321013">
          <path d={svgPaths.p24ff5f40} fill="var(--fill-0, #ACACAC)" id="Vector" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="content-stretch flex gap-[20px] items-center relative shrink-0">
      ...
      <div className="bg-white content-stretch flex h-[32px] items-center justify-between px-[15px] relative rounded-[30px] shrink-0 w-[250px]" data-name="Dropdown Small">
        ...
        <p className="font-['Poppins:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#3a3a3a] text-[14px] tracking-[-0.14px]">Choose Offering</p>
...
function ConfigureOfferingFrame() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Configure Offering/Frame 427320310">
      <Frame9 />
    </div>
  );
}
...
function Frame5() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-full">
      ...
      <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-full" data-name="Configure Offerings">
        <ConfigureOfferingFrame />
        <button className="content-stretch cursor-pointer flex items-center relative shrink-0" data-name="Add New">
          <div className="relative shrink-0 size-[30px]" data-name="Vector">
            <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 30 30">
              <path d={svgPaths.p1f1c3d00} fill="var(--fill-0, #4D4085)" id="Vector" />
            </svg>
          </div>
        </button>
      </div>
...
function Frame8() {
  return (
    <div className="content-stretch flex flex-col gap-[32px] h-[728px] items-start relative shrink-0 w-full">
      <Frame3 />
      <Frame4 />
    </div>
  );
...
function InnerFrame() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start justify-between min-h-px min-w-px relative w-full" data-name="Inner Frame">
      <Frame8 />
      <Buttons />
    </div>
  );
...
export default function EditOfferings() {
  return (
    <div className="bg-white content-stretch flex items-center relative size-full" data-name="Edit Offerings">
