import svgPaths from "./svg-15pj9qlc9g";
...
function Frame2() {
  return (
    <div className="content-stretch flex items-center relative shrink-0">
      <p className="font-['Montserrat:Bold',sans-serif] font-bold leading-[normal] relative shrink-0 text-[#4d4085] text-[27px]">{`Configure Password & Security`}</p>
    </div>
  );
}
...
function Frame3() {
  return (
    <div className="content-stretch flex flex-col items-start py-[5px] relative shrink-0">
      <Frame2 />
    </div>
  );
}
...
function Frame4() {
  return (
    <div className="content-stretch flex flex-col items-start pr-[10px] py-[10px] relative shrink-0">
      <p className="font-['Montserrat:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[#1c1c1c] text-[24px] tracking-[-0.24px]">Password Settings</p>
    </div>
  );
}
...
function Frame() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full">
      <p className="font-['Poppins:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[14px] text-black">Enter Password</p>
...
function Frame6() {
  return (
    <div className="content-stretch flex gap-[20px] items-center relative shrink-0 w-full">
      <p className="font-['Poppins:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[14px] text-black">Change Password Next Login</p>
      <button className="block cursor-pointer relative shrink-0 size-[16px]" data-name="Check Box">
...
function Frame13() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[20px] items-start min-h-px min-w-px relative">
      <Frame8 />
      <div className="content-stretch flex flex-col gap-[20px] h-[247px] items-start relative shrink-0 w-[590px]" data-name="User Password Settings">
        <Frame />
        <button className="bg-[#46367f] content-stretch cursor-pointer flex h-[35px] items-center justify-between py-[5px] relative rounded-[100px] shrink-0 w-[250px]" data-name="Apply Default Password">
          <div aria-hidden="true" className="absolute border border-[#46367f] border-solid inset-0 pointer-events-none rounded-[100px]" />
          <p className="font-['Montserrat:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[12px] text-left text-white">Apply Default Password</p>
        </button>
        <Frame6 />
      </div>
    </div>
...
function Frame5() {
  return (
    <div className="content-stretch flex flex-col items-start pr-[10px] py-[10px] relative shrink-0">
      <p className="font-['Montserrat:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[#1c1c1c] text-[24px] tracking-[-0.24px]">Two Factor Authentication</p>
    </div>
  );
}
...
function Frame7() {
  return (
    <div className="content-stretch flex gap-[20px] items-center not-italic relative shrink-0 w-full">
      <p className="font-['Poppins:Medium',sans-serif] leading-[normal] relative shrink-0 text-[14px] text-black">Phone no. Verified?</p>
      <p className="font-['Poppins:Regular',sans-serif] leading-[0] relative shrink-0 text-[#5b5b5b] text-[0px] text-[16px]">
        <span className="font-['Poppins:Bold',sans-serif] leading-[normal] text-[#5ea7a3]">{`Verified `}</span>
        <span className="leading-[normal]">08/08/23</span>
      </p>
    </div>
  );
}
...
function Frame9() {
  return (
    <div className="content-stretch flex gap-[20px] items-center not-italic relative shrink-0 w-full">
      <p className="font-['Poppins:Medium',sans-serif] leading-[normal] relative shrink-0 text-[14px] text-black">Email Verified?</p>
      <p className="font-['Poppins:Regular',sans-serif] leading-[0] relative shrink-0 text-[#5b5b5b] text-[0px] text-[16px]">
        <span className="font-['Poppins:Bold',sans-serif] leading-[normal] text-[#5ea7a3]">{`Verified `}</span>
        <span className="leading-[normal]">08/08/23</span>
      </p>
...
function Frame10() {
  return (
    <div className="content-stretch flex gap-[20px] items-center relative shrink-0 w-full">
      <p className="font-['Poppins:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[14px] text-black">Suppress MFA</p>
      <button className="block cursor-pointer relative shrink-0 size-[16px]" data-name="Check Box">
        <div className="absolute bg-white border border-[#46367f] border-solid inset-0 rounded-[5px]" />
      </button>
    </div>
...
export default function EditPassword() {
  return (
    <div className="bg-white content-stretch flex items-center relative size-full" data-name="Edit Password">
