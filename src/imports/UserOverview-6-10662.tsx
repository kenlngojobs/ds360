import svgPaths from "./svg-9xks2wr89d";
    ...
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0">
      <div className="col-1 h-[17.52px] ml-0 mt-[6.2%] relative row-1 w-[17.309px]" data-name="Union">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17.3091 17.5195">
          <path d={svgPaths.p2f426080} fill="var(--fill-0, black)" id="Union" />
        </svg>
      </div>
      <div className="col-1 flex flex-col font-['Poppins:Medium',sans-serif] justify-center ml-[22.31px] mt-0 not-italic relative row-1 text-[12px] text-black tracking-[-0.12px] w-[134.69px]" style={{ fontFeatureSettings: "\'ss01\', \'cv01\', \'cv11\'" }}>
...
function Users() {
  return (
    <div className="bg-white h-[36px] relative rounded-bl-[6px] rounded-tl-[6px] shrink-0 w-full" data-name="Users">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[20px] relative size-full">
          <Group8 />
        </div>
...
function Group17() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0">
      <div className="col-1 h-[19.911px] ml-0 mt-[1.17%] relative row-1 w-[17.5px]" data-name="Union">
...
function Frame9() {
  return (
    <div className="h-[6px] relative shrink-0 w-[10px]">
      <div className="absolute inset-[0_0_-6.9%_0]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10 6.41422">
          <g id="Frame 427320219">
            <path d="M1 1L4.97516 5L9 1" id="Vector 1" stroke="var(--stroke-0, #ACACAC)" strokeLinecap="round" strokeWidth="2" />
          </g>
        </svg>
      </div>
    </div>
    ...
    <div className="content-stretch flex gap-[10px] items-start relative shrink-0">
      <div className="relative shrink-0 size-[20px]">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
          <circle cx="10" cy="10" fill="var(--fill-0, white)" id="Ellipse 9" r="9.5" stroke="var(--stroke-0, #ACACAC)" />
        </svg>
      </div>
      <div className="absolute flex h-[14px] items-center justify-center left-[5px] top-[3px] w-[10px]" style={{ "--transform-inner-width": "1186.171875", "--transform-inner-height": "21.8125" } as React.CSSProperties}>
...
function Breadcrumb() {
  return (
    <div className="content-stretch flex gap-[10px] items-center relative shrink-0 w-full" data-name="Breadcrumb">
      <p className="font-['Montserrat:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[#5b5b5b] text-[14px]">Users</p>
      <Frame13 />
      <p className="font-['Montserrat:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[#5ea7a3] text-[14px]">User Profile</p>
    </div>
  );
}
...
function TopHeader() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-full" data-name="Top Header">
      <p className="font-['Montserrat:Bold',sans-serif] font-bold leading-[normal] relative shrink-0 text-[#4d4085] text-[27px] w-full whitespace-pre-wrap">User Profile</p>
      <Breadcrumb />
      <p className="font-['Montserrat:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[#1c1c1c] text-[24px] tracking-[-0.24px] w-full whitespace-pre-wrap">Amy Dowdy</p>
    </div>
  );
}
...
function Frame3() {
  return (
    <button className="content-stretch cursor-pointer flex items-center justify-center px-[10px] py-[5px] relative shrink-0 w-[110px]">
      <p className="font-['Montserrat:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[#3a3a3a] text-[18px] text-left">Overview</p>
    </button>
  );
}
...
function Frame4() {
  return (
    <div className="content-stretch flex items-center justify-center px-[10px] py-[5px] relative shrink-0">
      <p className="font-['Montserrat:Bold',sans-serif] font-bold leading-[normal] relative shrink-0 text-[#46367f] text-[18px] text-center">Configure</p>
    </div>
  );
}
...
function Header() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start shrink-0 sticky top-0 w-full" data-name="Header">
      <TopHeader />
      <div className="content-stretch flex gap-[10px] items-start relative shrink-0 w-full" data-name="Overview / Settings Toggle">
        <div className="absolute h-0 left-[130px] top-[32px] w-[95px]">
          <div className="absolute inset-[-1px_-1.05%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 97 2">
              <path d="M1 1H96" id="Line 217" stroke="var(--stroke-0, #46367F)" strokeLinecap="round" strokeWidth="2" />
            </svg>
          </div>
        </div>
        <Frame3 />
...
function Frame8() {
  return (
    <div className="content-stretch flex h-[35px] items-center pr-[10px] py-[10px] relative shrink-0">
      <p className="font-['Poppins:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[14px] text-black">User Configuration Options</p>
    </div>
  );
}
...
function Frame5() {
  return (
    <div className="content-stretch flex items-center py-[4px] relative shrink-0 w-full">
      <div aria-hidden="true" className="absolute border-[#46367f] border-b border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col font-['Montserrat:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#46367f] text-[18px] whitespace-nowrap">
        <p className="leading-[normal]">Configure User Access</p>
      </div>
    </div>
  );
}
...
function Group() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0">
      <div className="col-1 ml-0 mt-[5px] relative row-1 size-[8px]">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 8 8">
          <circle cx="4" cy="4" fill="var(--fill-0, #46367F)" id="Ellipse 1" r="4" />
        </svg>
      </div>
      <p className="col-1 font-['Poppins:Regular',sans-serif] leading-[normal] ml-[13px] mt-0 not-italic relative row-1 text-[#3a3a3a] text-[12px] w-[359px] whitespace-pre-wrap">Configure User Access</p>
    </div>
  );
}
...
function Group1() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0">
      ...
      <p className="col-1 font-['Poppins:Regular',sans-serif] leading-[normal] ml-[13px] mt-0 not-italic relative row-1 text-[#3a3a3a] text-[12px] w-[359px] whitespace-pre-wrap">Define user roles and access levels for system control.</p>
    </div>
  );
}
...
function UserAccess() {
  return (
    <div className="bg-white flex-[1_0_0] h-full min-h-px min-w-px relative rounded-[10px]" data-name="User Access">
      <div aria-hidden="true" className="absolute border border-[#737373] border-solid inset-0 pointer-events-none rounded-[10px]" />
      <div className="flex flex-col items-end size-full">
        <div className="content-stretch flex flex-col items-end justify-between px-[20px] py-[10px] relative size-full">
          <Frame17 />
          <div className="bg-white content-stretch flex items-end justify-center px-[20px] py-[10px] relative rounded-[100px] shrink-0 w-[150px]" data-name="Small Button">
            <div aria-hidden="true" className="absolute border border-[#46367f] border-solid inset-0 pointer-events-none rounded-[100px]" />
            <p className="font-['Montserrat:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[#46367f] text-[12px]">Configure Now</p>
          </div>
        </div>
      </div>
    </div>
...
function Frame6() {
  return (
    <div className="content-stretch flex items-center py-[5px] relative shrink-0 w-full">
      <div aria-hidden="true" className="absolute border-[#46367f] border-b border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col font-['Montserrat:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#46367f] text-[18px] whitespace-nowrap">
        <p className="leading-[normal]">Configure Offering Access</p>
      </div>
    </div>
  );
}
...
function Group2() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0">
      ...
      <p className="col-1 font-['Poppins:Regular',sans-serif] leading-[normal] ml-[13px] mt-0 not-italic relative row-1 text-[#3a3a3a] text-[12px] w-[359px] whitespace-pre-wrap">Define permissions and restrictions for accessing specific services or products.</p>
    </div>
  );
}
...
function Group3() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0">
      ...
      <p className="col-1 font-['Poppins:Regular',sans-serif] leading-[normal] ml-[13px] mt-0 not-italic relative row-1 text-[#3a3a3a] text-[12px] w-[359px] whitespace-pre-wrap">Set up user roles and privileges for offering access management.</p>
    </div>
  );
}
...
function Offerings1() {
  return (
    <div className="bg-white flex-[1_0_0] h-full min-h-px min-w-px relative rounded-[10px]" data-name="Offerings">
      <div aria-hidden="true" className="absolute border border-[#737373] border-solid inset-0 pointer-events-none rounded-[10px]" />
      <div className="flex flex-col items-end size-full">
        <div className="content-stretch flex flex-col items-end justify-between px-[20px] py-[10px] relative size-full">
          <Frame14 />
...
function Frame() {
  return (
    <div className="content-stretch flex gap-[10px] h-[200px] items-start relative shrink-0 w-full">
      <UserAccess />
      <Offerings1 />
    </div>
  );
...
function Frame7() {
  return (
    <div className="content-stretch flex items-center py-[4px] relative shrink-0 w-full">
      <div aria-hidden="true" className="absolute border-[#46367f] border-b border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col font-['Montserrat:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#46367f] text-[18px] whitespace-nowrap">
        <p className="leading-[normal]">Configure Notifications</p>
      </div>
    </div>
  );
}
...
function Group4() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0">
      ...
      <p className="col-1 font-['Poppins:Regular',sans-serif] leading-[normal] ml-[13px] mt-0 not-italic relative row-1 text-[#3a3a3a] text-[12px] w-[359px] whitespace-pre-wrap">Customize alert settings for various events and updates.</p>
    </div>
  );
}
...
function Group5() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0">
      ...
      <p className="col-1 font-['Poppins:Regular',sans-serif] leading-[normal] ml-[13px] mt-0 not-italic relative row-1 text-[#3a3a3a] text-[12px] w-[359px] whitespace-pre-wrap">Choose the preferred communication channels and notification preferences.</p>
    </div>
  );
}
...
function Notifications() {
  return (
    <div className="bg-white flex-[1_0_0] h-full min-h-px min-w-px relative rounded-[10px]" data-name="Notifications">
...
function Frame18() {
  return (
    <div className="content-stretch flex items-start py-[5px] relative shrink-0 w-full">
      <div aria-hidden="true" className="absolute border-[#46367f] border-b border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col font-['Montserrat:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#46367f] text-[18px] whitespace-nowrap">
        <p className="leading-[normal]">{`Configure Password & Security`}</p>
      </div>
    </div>
  );
}
...
function Group6() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0">
      ...
      <p className="col-1 font-['Poppins:Regular',sans-serif] leading-[normal] ml-[13px] mt-0 not-italic relative row-1 text-[#3a3a3a] text-[12px] w-[359px] whitespace-pre-wrap">Control how users create, reset, and manage their passwords securely.</p>
    </div>
  );
}
...
function Group7() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0">
      ...
      <p className="col-1 font-['Poppins:Regular',sans-serif] leading-[normal] ml-[13px] mt-0 not-italic relative row-1 text-[#3a3a3a] text-[12px] w-[359px] whitespace-pre-wrap">Additional security measures like account recovery options and password expiration.</p>
    </div>
  );
}
...
function Password() {
  return (
    <div className="bg-white flex-[1_0_0] h-full min-h-px min-w-px relative rounded-[10px]" data-name="Password">
      <div className="flex flex-col items-end overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-end justify-between px-[20px] py-[10px] relative size-full">
          <Frame16 />
          <div className="bg-white content-stretch flex items-end justify-center px-[20px] py-[10px] relative rounded-[100px] shrink-0 w-[150px]" data-name="Small Button">
...
function InnerFrame() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[15px] items-start min-h-px min-w-px overflow-clip relative w-full" data-name="Inner Frame">
      <Header />
      <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-full" data-name="User Settings">
        <Frame8 />
        <Frame />
        <Frame1 />
      </div>
...
function ContentArea() {
  return (
    <div className="flex-[1_0_0] h-full min-h-px min-w-px relative" data-name="Content Area">
...
export default function UserOverview() {
  return (
    <div className="bg-white content-stretch flex items-start relative size-full" data-name="User Overview">
